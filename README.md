...
# ⚡ Hi there, I'm Muhammad Hussain Memon 👋
...
```javascript
const developer = {
    name: "Muhammad Hussain Memon",
    alias: "MHM.dev",
    location: "Karachi, Pakistan 🇵🇰",
    role: "Full-Stack Web Developer",
    education: "Software Technology @ Jinnah Polytechnic Institute",
    training: "Web & Mobile App Development @ Saylani Mass IT Training (SMIT)",
    interests: ["MERN Stack", "Interactive UI Animations", "Scalable Web Systems"],
    currentFocus: "Building production-grade MERN applications with modern UI/UX"
};
